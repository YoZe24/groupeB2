...
public class ElementControl implements Serializable {
	...
	private User userTest = new User("userTestName", "userTestFirstName", "userTestMail", "userTestLogin", "testMDP", "00000", "2010", EnumSection.SANTE, addressUserTest, EnumRole.ADMINISTRATOR);
