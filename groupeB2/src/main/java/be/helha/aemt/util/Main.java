...
public class Main {
	...
	public static void main(String[] args) {
		...
		User userTest = new User("userTestName", "userTestFirstName", "userTestMail", "userTestLogin", "testMDP", "00000","test",EnumSection.COMPTABILITE, addressUserTest, EnumRole.ADMINISTRATOR);
